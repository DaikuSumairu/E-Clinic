...
<!-- Tabs Title -->
@section('title', 'Medical Exam')

<!-- Content Header -->
@section('content_header')
    <h1>Updating Medical Exam for {{ $medical_exam->record->user->name }}</h1>
@stop

<!-- Content Body -->
@section('content')
<!-- Go back from the last page -->
<a class="btn btn-danger mb-2" href="{{ route('doctor.recordShow', $medical_exam->record->id) }}">Go Back</a>

<!-- Body -->
<div class="container-xxl mb-2 record-customize-create-container-height border">
    <form method="POST" action="{{ route('doctor.medicalExamUpdate', $medical_exam->id ) }}" onsubmit="return confirm('Are you sure you want to submit this medical exam?');">
        @csrf
        @method('PUT')
                ...
                <table class="table table-sm table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="text-center py-4">
                            @if($medical_exam->past_medical_history->pmh_allergies === 'Yes')
                            <input type="checkbox" id="pmh_allergies" name="pmh_allergies" value="Yes" onchange="toggleText_area('pmh_allergies')" checked>
                            @else
                            <input type="checkbox" id="pmh_allergies" name="pmh_allergies" value="Yes" onchange="toggleText_area('pmh_allergies')">
                            @endif
                        </td>
                        <td class="text-center">
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-pmh_allergies" rows="2" name="pmh_allergies_findings" required>
                                {{ $medical_exam->past_medical_history->pmh_finding->pmh_allergies_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>Skin Disease</td>
                        <td class="text-center py-4">
                            @if($medical_exam->past_medical_history->pmh_skin_disease === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="pmh_skin_disease" name="pmh_skin_disease" value="Yes" onchange="toggleText_area('pmh_skin_disease')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->past_medical_history->pmh_skin_disease === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-pmh_skin_disease" rows="2" name="pmh_skin_disease_findings" required>
                                {{ $medical_exam->past_medical_history->pmh_finding->pmh_skin_disease_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center py-4">
                            @if($medical_exam->past_medical_history->pmh_opthalmologic_disorder === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="pmh_opthalmologic_disorder" name="pmh_opthalmologic_disorder" value="Yes" onchange="toggleText_area('pmh_opthalmologic_disorder')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->past_medical_history->pmh_opthalmologic_disorder === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-pmh_opthalmologic_disorder" rows="2" name="pmh_opthalmologic_disorder_findings" required>
                                {{ $medical_exam->past_medical_history->pmh_finding->pmh_opthalmologic_disorder_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>ENT Disorder</td>
                        <td class="text-center py-4">
                            @if($medical_exam->past_medical_history->pmh_ent_disorder === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="pmh_ent_disorder" name="pmh_ent_disorder" value="Yes" onchange="toggleText_area('pmh_ent_disorder')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->past_medical_history->pmh_ent_disorder === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-pmh_ent_disorder" rows="2" name="pmh_ent_disorder_findings" required>
                                {{ $medical_exam->past_medical_history->pmh_finding->pmh_ent_disorder_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center py-4">
                            @if($medical_exam->past_medical_history->pmh_bronchial_asthma === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="pmh_bronchial_asthma" name="pmh_bronchial_asthma" value="Yes" onchange="toggleText_area('pmh_bronchial_asthma')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->past_medical_history->pmh_bronchial_asthma === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-pmh_bronchial_asthma" rows="2" name="pmh_bronchial_asthma_findings" required>
                                {{ $medical_exam->past_medical_history->pmh_finding->pmh_bronchial_asthma_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center py-4">
                            @if($medical_exam->past_medical_history->pmh_cardiac_disorder === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="pmh_cardiac_disorder" name="pmh_cardiac_disorder" value="Yes" onchange="toggleText_area('pmh_cardiac_disorder')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->past_medical_history->pmh_cardiac_disorder === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-pmh_cardiac_disorder" rows="2" name="pmh_cardiac_disorder_findings" required>
                                {{ $medical_exam->past_medical_history->pmh_finding->pmh_cardiac_disorder_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center py-4">
                            @if($medical_exam->past_medical_history->pmh_diabetes_mellitus === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="pmh_diabetes_mellitus" name="pmh_diabetes_mellitus" value="Yes" onchange="toggleText_area('pmh_diabetes_mellitus')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->past_medical_history->pmh_diabetes_mellitus === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-pmh_diabetes_mellitus" rows="2" name="pmh_diabetes_mellitus_findings" required>
                                {{ $medical_exam->past_medical_history->pmh_finding->pmh_diabetes_mellitus_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center py-4">
                            @if($medical_exam->past_medical_history->pmh_chronic_headache === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="pmh_chronic_headache" name="pmh_chronic_headache" value="Yes" onchange="toggleText_area('pmh_chronic_headache')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->past_medical_history->pmh_chronic_headache === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-pmh_chronic_headache" rows="2" name="pmh_chronic_headache_findings" required>
                                {{ $medical_exam->past_medical_history->pmh_finding->pmh_chronic_headache_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>Hepatitis</td>
                        <td class="text-center py-4">
                            @if($medical_exam->past_medical_history->pmh_hepatitis === 'Yes')
                            <input type="checkbox" id="pmh_hepatitis" name="pmh_hepatitis" value="Yes" onchange="toggleText_area('pmh_hepatitis')" checked>
                            @else
                            <input type="checkbox" id="pmh_hepatitis" name="pmh_hepatitis" value="Yes" onchange="toggleText_area('pmh_hepatitis')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->past_medical_history->pmh_hepatitis === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-pmh_hepatitis" rows="2" name="pmh_hepatitis_findings" required>
                                {{ $medical_exam->past_medical_history->pmh_finding->pmh_hepatitis_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>Hypertension</td>
                        <td class="text-center py-4">
                            @if($medical_exam->past_medical_history->pmh_hypertension === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="pmh_hypertension" name="pmh_hypertension" value="Yes" onchange="toggleText_area('pmh_hypertension')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->past_medical_history->pmh_hypertension === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-pmh_hypertension" rows="2" name="pmh_hypertension_findings" required>
                                {{ $medical_exam->past_medical_history->pmh_finding->pmh_hypertension_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center py-4">
                            @if($medical_exam->past_medical_history->pmh_thyroid_disorder === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="pmh_thyroid_disorder" name="pmh_thyroid_disorder" value="Yes" onchange="toggleText_area('pmh_thyroid_disorder')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->past_medical_history->pmh_thyroid_disorder === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-pmh_thyroid_disorder" rows="2" name="pmh_thyroid_disorder_findings" required>
                                {{ $medical_exam->past_medical_history->pmh_finding->pmh_thyroid_disorder_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center py-4">
                            @if($medical_exam->past_medical_history->pmh_blood_disorder === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="pmh_blood_disorder" name="pmh_blood_disorder" value="Yes" onchange="toggleText_area('pmh_blood_disorder')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->past_medical_history->pmh_blood_disorder === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-pmh_blood_disorder" rows="2" name="pmh_blood_disorder_findings" required>
                                {{ $medical_exam->past_medical_history->pmh_finding->pmh_blood_disorder_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>Tuberculosis</td>
                        <td class="text-center py-4">
                            @if($medical_exam->past_medical_history->pmh_tuberculosis === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="pmh_tuberculosis" name="pmh_tuberculosis" value="Yes" onchange="toggleText_area('pmh_tuberculosis')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->past_medical_history->pmh_tuberculosis === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-pmh_tuberculosis" rows="2" name="pmh_tuberculosis_findings" required>
                                {{ $medical_exam->past_medical_history->pmh_finding->pmh_tuberculosis_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>Peptic Ulcer</td>
                        <td class="text-center py-4">
                            @if($medical_exam->past_medical_history->pmh_peptic_ulcer === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="pmh_peptic_ulcer" name="pmh_peptic_ulcer" value="Yes" onchange="toggleText_area('pmh_peptic_ulcer')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->past_medical_history->pmh_peptic_ulcer === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-pmh_peptic_ulcer" rows="2" name="pmh_peptic_ulcer_findings" required>
                                {{ $medical_exam->past_medical_history->pmh_finding->pmh_peptic_ulcer_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center py-4">
                            @if($medical_exam->past_medical_history->pmh_musculoskeletal_disorder === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="pmh_musculoskeletal_disorder" name="pmh_musculoskeletal_disorder" value="Yes" onchange="toggleText_area('pmh_musculoskeletal_disorder')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->past_medical_history->pmh_musculoskeletal_disorder === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-pmh_musculoskeletal_disorder" rows="2" name="pmh_musculoskeletal_disorder_findings" required>
                                {{ $medical_exam->past_medical_history->pmh_finding->pmh_musculoskeletal_disorder_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center py-4">
                            @if($medical_exam->past_medical_history->pmh_infectious_disease === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="pmh_infectious_disease" name="pmh_infectious_disease" value="Yes" onchange="toggleText_area('pmh_infectious_disease')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->past_medical_history->pmh_infectious_disease === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-pmh_infectious_disease" rows="2" name="pmh_infectious_disease_findings" required>
                                {{ $medical_exam->past_medical_history->pmh_finding->pmh_infectious_disease_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
            ...
            <div class="col">
                ...
                <table class="table table-sm table-bordered">
                    ...
                    <tr>
                        <td>Bronchial Asthma</td>
                        <td class="text-center py-4">
                            @if($medical_exam->family_history->fh_bronchial_asthma === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="fh_bronchial_asthma" name="fh_bronchial_asthma" value="Yes" onchange="toggleText_area('fh_bronchial_asthma')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->family_history->fh_bronchial_asthma === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-fh_bronchial_asthma" rows="2" name="fh_bronchial_asthma_findings" required>
                                {{ $medical_exam->family_history->fh_finding->fh_bronchial_asthma_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>Diabetes Mellitus</td>
                        <td class="text-center py-4">
                            @if($medical_exam->family_history->fh_diabetes_mellitus === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="fh_diabetes_mellitus" name="fh_diabetes_mellitus" value="Yes" onchange="toggleText_area('fh_diabetes_mellitus')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->family_history->fh_diabetes_mellitus === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-fh_diabetes_mellitus" rows="2" name="fh_diabetes_mellitus_findings" required>
                                {{ $medical_exam->family_history->fh_finding->fh_diabetes_mellitus_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>Thyroid Disorder</td>
                        <td class="text-center py-4">
                            @if($medical_exam->family_history->fh_thyroid_disease === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="fh_thyroid_disease" name="fh_thyroid_disease" value="Yes" onchange="toggleText_area('fh_thyroid_disease')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->family_history->fh_thyroid_disease === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-fh_thyroid_disease" rows="2" name="fh_thyroid_disease_findings" required>
                                {{ $medical_exam->family_history->fh_finding->fh_thyroid_disease_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center py-4">
                            @if($medical_exam->family_history->fh_opthalmologic_disease === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="fh_opthalmologic_disease" name="fh_opthalmologic_disease" value="Yes" onchange="toggleText_area('fh_opthalmologic_disease')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->family_history->fh_opthalmologic_disease === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-fh_opthalmologic_disease" rows="2" name="fh_opthalmologic_disease_findings" required>
                                {{ $medical_exam->family_history->fh_finding->fh_opthalmologic_disease_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>Cancer</td>
                        <td class="text-center py-4">
                            @if($medical_exam->family_history->fh_cancer === 'Yes')
                            <input type="checkbox" id="fh_cancer" name="fh_cancer" value="Yes" onchange="toggleText_area('fh_cancer')" checked>
                            @else
                            <input type="checkbox" id="fh_cancer" name="fh_cancer" value="Yes" onchange="toggleText_area('fh_cancer')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->family_history->fh_cancer === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-fh_cancer" rows="2" name="fh_cancer_findings" required>
                                {{ $medical_exam->family_history->fh_finding->fh_cancer_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>Cardiac Disorder</td>
                        <td class="text-center py-4">
                            @if($medical_exam->family_history->fh_cardiac_disorder === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="fh_cardiac_disorder" name="fh_cardiac_disorder" value="Yes" onchange="toggleText_area('fh_cardiac_disorder')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->family_history->fh_cardiac_disorder === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-fh_cardiac_disorder" rows="2" name="fh_cardiac_disorder_findings" required>
                                {{ $medical_exam->family_history->fh_finding->fh_cardiac_disorder_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>Hypertension</td>
                        <td class="text-center py-4">
                            @if($medical_exam->family_history->fh_hypertension === 'Yes')
                            <input type="checkbox" id="fh_hypertension" name="fh_hypertension" value="Yes" onchange="toggleText_area('fh_hypertension')" checked>
                            @else
                            <input type="checkbox" id="fh_hypertension" name="fh_hypertension" value="Yes" onchange="toggleText_area('fh_hypertension')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->family_history->fh_hypertension === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-fh_hypertension" rows="2" name="fh_hypertension_findings" required>
                                {{ $medical_exam->family_history->fh_finding->fh_hypertension_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>Tuberculosis</td>
                        <td class="text-center py-4">
                            @if($medical_exam->family_history->fh_tuberculosis === 'Yes')
                            <input type="checkbox" id="fh_tuberculosis" name="fh_tuberculosis" value="Yes" onchange="toggleText_area('fh_tuberculosis')" checked>
                            @else
                            <input type="checkbox" id="fh_tuberculosis" name="fh_tuberculosis" value="Yes" onchange="toggleText_area('fh_tuberculosis')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->family_history->fh_tuberculosis === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-fh_tuberculosis" rows="2" name="fh_tuberculosis_findings" required>
                                {{ $medical_exam->family_history->fh_finding->fh_tuberculosis_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center py-4">
                            @if($medical_exam->family_history->fh_nervous_disorder === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="fh_nervous_disorder" name="fh_nervous_disorder" value="Yes" onchange="toggleText_area('fh_nervous_disorder')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->family_history->fh_nervous_disorder === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-fh_nervous_disorder" rows="2" name="fh_nervous_disorder_findings" required>
                                {{ $medical_exam->family_history->fh_finding->fh_nervous_disorder_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center py-4">
                            @if($medical_exam->family_history->fh_musculoskeletal === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="fh_musculoskeletal" name="fh_musculoskeletal" value="Yes" onchange="toggleText_area('fh_musculoskeletal')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->family_history->fh_musculoskeletal === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-fh_musculoskeletal" rows="2" name="fh_musculoskeletal_findings" required>
                                {{ $medical_exam->family_history->fh_finding->fh_musculoskeletal_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>Liver Disease</td>
                        <td class="text-center py-4">
                            @if($medical_exam->family_history->fh_liver_disease === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="fh_liver_disease" name="fh_liver_disease" value="Yes" onchange="toggleText_area('fh_liver_disease')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->family_history->fh_liver_disease === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-fh_liver_disease" rows="2" name="fh_liver_disease_findings" required>
                                {{ $medical_exam->family_history->fh_finding->fh_liver_disease_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center py-4">
                            @if($medical_exam->family_history->fh_kidney_disease === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="fh_kidney_disease" name="fh_kidney_disease" value="Yes" onchange="toggleText_area('fh_kidney_disease')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->family_history->fh_kidney_disease === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-fh_kidney_disease" rows="2" name="fh_kidney_disease_findings" required>
                                {{ $medical_exam->family_history->fh_finding->fh_kidney_disease_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="row row-cols-3 pt-1 mx-auto border-top border-left border-right">
                    <div class="col">
                        <label class="info h4 mb-0">
                            @if($medical_exam->personal_social->smoker === 'Yes')
                            <input type="checkbox" class="customize-checkbox mr-1" id="smoker" name="smoker" value="Yes" onchange="toggleNumber(this, 'smoker')" checked>
                            @else
                    ...
                    @if($medical_exam->personal_social->smoker === 'Yes')
                    <div class="col">
                        <input type="number" class="customize-input-number mr-1" id="day" name="day" value="{{ $medical_exam->personal_social->day }}" required>
                        <span class="info customize-checkbox-label">sticks / day</span>
                    </div>
                    <div class="col">
                        <input type="number" class="customize-input-number mr-1" id="year" name="year" value="{{ $medical_exam->personal_social->year }}" required>
                ...
                <div class="row row-cols-3 pt-1 mx-auto border-bottom border-left border-right">
                    <div class="col">
                        <label class="info h4 mb-0">
                            @if($medical_exam->personal_social->alcoholic === 'Yes')
                            <input type="checkbox" class="customize-checkbox mr-1" id="alcoholic" name="alcoholic" value="Yes" onchange="toggleNumber(this, 'alcoholic')" checked>
                            @else
                    ...
                    @if($medical_exam->personal_social->alcoholic === 'Yes')
                    <div class="col">
                        <input type="number" class="customize-input-number mr-1" id="shot" name="shot" value="{{ $medical_exam->personal_social->shot }}" required>
                        <span class="info customize-checkbox-label">bottle / shots</span>
                    </div>
                    <div class="col">
                        <input type="number" class="customize-input-number mr-1" id="week" name="week" value="{{ $medical_exam->personal_social->week }}" required>
                ...
                <div class="row py-1 mx-auto mt-1 border">
                    <div class="col col-sm-2">
                        <label class="info h5 mb-0">
                            @if($medical_exam->personal_social->hospitalization === 'Yes')
                            <input type="checkbox" class="customize-checkbox mr-1" id="hospitalization" name="hospitalization" value="Yes" onchange="toggleNumber(this, 'hospitalization')" checked>
                            @else
                    ...
                    <div class="col">
                        @if($medical_exam->personal_social->hospitalization === 'Yes')
                        <input type="number" class="form-control" id="hospitalization_result" name="hospitalization_result" value="{{ $medical_exam->personal_social->hospitalization_result }}" required>
                        @else
                    ...
                    <div class="col col-sm-2">
                        <label class="info h4 mb-0">
                            @if($medical_exam->personal_social->operation === 'Yes')
                            <input type="checkbox" class="customize-checkbox mr-1" id="operation" name="operation" value="Yes" onchange="toggleNumber(this, 'operation')" checked>
                            @else
                    ...
                    <div class="col">
                        @if($medical_exam->personal_social->operation === 'Yes')
                        <input type="number" class="form-control" id="operation_result" name="operation_result" value="{{ $medical_exam->personal_social->operation_result }}" required>
                        @else
                ...
                <div class="row py-1 mx-auto mt-1 border">
                    <div class="col">
                        <label class="info mb-0">
                            @if($medical_exam->personal_social->medication === 'Yes')
                            <input type="checkbox" class="customize-checkbox mr-1" id="medication" name="medication" value="Yes" onchange="toggleNumber(this, 'medication')" checked>
                            @else
                        ...
                        @if($medical_exam->personal_social->medication === 'Yes')
                        <textarea class="form-control" id="med_take" rows="2" name="med_take" required>{{ $medical_exam->personal_social->med_take }}</textarea>
                        @else
            ...
            <div class="col">
                ...
                <table class="table table-sm table-bordered">
                    ...
                    <tr>
                        <td>LNMP</td>
                        <td class="text-center py-4">
                            @if($medical_exam->ob_gyne_review->obg_lnmp === 'Yes')
                            <input type="checkbox" id="obg_lnmp" name="obg_lnmp" value="Yes" onchange="toggleText_area('obg_lnmp')" checked>
                            @else
                            <input type="checkbox" id="obg_lnmp" name="obg_lnmp" value="Yes" onchange="toggleText_area('obg_lnmp')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->ob_gyne_review->obg_lnmp === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-obg_lnmp" rows="2" name="obg_lnmp_findings" required>
                                {{ $medical_exam->ob_gyne_review->obr_finding->obg_lnmp_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>OB Score</td>
                        <td class="text-center py-4">
                            @if($medical_exam->ob_gyne_review->obg_ob_score === 'Yes')
                            <input type="checkbox" id="obg_ob_score" name="obg_ob_score" value="Yes" onchange="toggleText_area('obg_ob_score')" checked>
                            @else
                            <input type="checkbox" id="obg_ob_score" name="obg_ob_score" value="Yes" onchange="toggleText_area('obg_ob_score')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->ob_gyne_review->obg_ob_score === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-obg_ob_score" rows="2" name="obg_ob_score_findings" required>
                                {{ $medical_exam->ob_gyne_review->obr_finding->obg_ob_score_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center py-4">
                            @if($medical_exam->ob_gyne_review->obg_abnormal_pregnancies === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="obg_abnormal_pregnancies" name="obg_abnormal_pregnancies" value="Yes" onchange="toggleText_area('obg_abnormal_pregnancies')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->ob_gyne_review->obg_abnormal_pregnancies === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-obg_abnormal_pregnancies" rows="2" name="obg_abnormal_pregnancies_findings" required>
                                {{ $medical_exam->ob_gyne_review->obr_finding->obg_abnormal_pregnancies_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center py-4">
                            @if($medical_exam->ob_gyne_review->obg_last_delivery === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="obg_last_delivery" name="obg_last_delivery" value="Yes" onchange="toggleText_area('obg_last_delivery')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->ob_gyne_review->obg_last_delivery === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-obg_last_delivery" rows="2" name="obg_last_delivery_findings" required>
                                {{ $medical_exam->ob_gyne_review->obr_finding->obg_last_delivery_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center py-4">
                            @if($medical_exam->ob_gyne_review->obg_breast_uterus_ovaries === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="obg_breast_uterus_ovaries" name="obg_breast_uterus_ovaries" value="Yes" onchange="toggleText_area('obg_breast_uterus_ovaries')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->ob_gyne_review->obg_breast_uterus_ovaries === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-obg_breast_uterus_ovaries" rows="2" name="obg_breast_uterus_ovaries_findings" required>
                                {{ $medical_exam->ob_gyne_review->obr_finding->obg_breast_uterus_ovaries_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
            ...
            <div class="col">
                ...
                <table class="table table-sm table-bordered">
                    ...
                    <tr>
                        <td>Skin</td>
                        <td class="text-center py-4">
                            @if($medical_exam->ob_gyne_review->rs_skin === 'Yes')
                            <input type="checkbox" id="rs_skin" name="rs_skin" value="Yes" onchange="toggleText_area('rs_skin')" checked>
                            @else
                            <input type="checkbox" id="rs_skin" name="rs_skin" value="Yes" onchange="toggleText_area('rs_skin')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->ob_gyne_review->rs_skin === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-rs_skin" rows="2" name="rs_skin_findings">
                                {{ $medical_exam->ob_gyne_review->obr_finding->rs_skin_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>Opthalmologic</td>
                        <td class="text-center py-4">
                            @if($medical_exam->ob_gyne_review->rs_opthalmologic === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="rs_opthalmologic" name="rs_opthalmologic" value="Yes" onchange="toggleText_area('rs_opthalmologic')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->ob_gyne_review->rs_opthalmologic === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-rs_opthalmologic" rows="2" name="rs_opthalmologic_findings">
                                {{ $medical_exam->ob_gyne_review->obr_finding->rs_opthalmologic_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>ENT</td>
                        <td class="text-center py-4">
                            @if($medical_exam->ob_gyne_review->rs_ent === 'Yes')
                            <input type="checkbox" id="rs_ent" name="rs_ent" value="Yes" onchange="toggleText_area('rs_ent')" checked>
                            @else
                            <input type="checkbox" id="rs_ent" name="rs_ent" value="Yes" onchange="toggleText_area('rs_ent')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->ob_gyne_review->rs_ent === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-rs_ent" rows="2" name="rs_ent_findings">
                                {{ $medical_exam->ob_gyne_review->obr_finding->rs_ent_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center py-4">
                            @if($medical_exam->ob_gyne_review->rs_cardiovascular === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="rs_cardiovascular" name="rs_cardiovascular" value="Yes" onchange="toggleText_area('rs_cardiovascular')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->ob_gyne_review->rs_cardiovascular === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-rs_cardiovascular" rows="2" name="rs_cardiovascular_findings">
                                {{ $medical_exam->ob_gyne_review->obr_finding->rs_cardiovascular_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>Respiratory</td>
                        <td class="text-center py-4">
                            @if($medical_exam->ob_gyne_review->rs_respiratory === 'Yes')
                            <input type="checkbox" id="rs_respiratory" name="rs_respiratory" value="Yes" onchange="toggleText_area('rs_respiratory')" checked>
                            @else
                            <input type="checkbox" id="rs_respiratory" name="rs_respiratory" value="Yes" onchange="toggleText_area('rs_respiratory')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->ob_gyne_review->rs_respiratory === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-rs_respiratory" rows="2" name="rs_respiratory_findings">
                                {{ $medical_exam->ob_gyne_review->obr_finding->rs_respiratory_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center py-4">
                            @if($medical_exam->ob_gyne_review->rs_gastro_intestinal === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="rs_gastro_intestinal" name="rs_gastro_intestinal" value="Yes" onchange="toggleText_area('rs_gastro_intestinal')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->ob_gyne_review->rs_gastro_intestinal === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-rs_gastro_intestinal" rows="2" name="rs_gastro_intestinal_findings">
                                {{ $medical_exam->ob_gyne_review->obr_finding->rs_gastro_intestinal_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center py-4">
                            @if($medical_exam->ob_gyne_review->rs_neuro_psychiatric === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="rs_neuro_psychiatric" name="rs_neuro_psychiatric" value="Yes" onchange="toggleText_area('rs_neuro_psychiatric')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->ob_gyne_review->rs_neuro_psychiatric === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-rs_neuro_psychiatric" rows="2" name="rs_neuro_psychiatric_findings">
                                {{ $medical_exam->ob_gyne_review->obr_finding->rs_neuro_psychiatric_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>Hermatology</td>
                        <td class="text-center py-4">
                            @if($medical_exam->ob_gyne_review->rs_hematology === 'Yes')
                            <input type="checkbox" id="rs_hematology" name="rs_hematology" value="Yes" onchange="toggleText_area('rs_hematology')" checked>
                            @else
                            <input type="checkbox" id="rs_hematology" name="rs_hematology" value="Yes" onchange="toggleText_area('rs_hematology')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->ob_gyne_review->rs_hematology === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-rs_hematology" rows="2" name="rs_hematology_findings">
                                {{ $medical_exam->ob_gyne_review->obr_finding->rs_hematology_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>Genitourinary</td>
                        <td class="text-center py-4">
                            @if($medical_exam->ob_gyne_review->rs_genitourinary === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="rs_genitourinary" name="rs_genitourinary" value="Yes" onchange="toggleText_area('rs_genitourinary')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->ob_gyne_review->rs_genitourinary === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-rs_genitourinary" rows="2" name="rs_genitourinary_findings">
                                {{ $medical_exam->ob_gyne_review->obr_finding->rs_genitourinary_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center py-4">
                            @if($medical_exam->ob_gyne_review->rs_musculo_skeletal === 'Yes')
                            ...
                            @else
                            <input type="checkbox" id="rs_musculo_skeletal" name="rs_musculo_skeletal" value="Yes" onchange="toggleText_area('rs_musculo_skeletal')">
                            @endif
                        </td>
                        <td class="text-center">
                            @if($medical_exam->ob_gyne_review->rs_musculo_skeletal === 'Yes')
                            ...
                            @else
                            <textarea class="form-control" id="findingText_area-rs_musculo_skeletal" rows="2" name="rs_musculo_skeletal_findings">
                                {{ $medical_exam->ob_gyne_review->obr_finding->rs_musculo_skeletal_findings }}
                            </textarea>
                            @endif
                        </td>
                    </tr>
                ...
                <div class="row mx-auto my-1">
                    ...
                    <div class="col border">
                        <div class="row row-cols-1">
                            ...
                            <div class="col text-center pb-2">
                                <input type="number" class="physical_exam_input" id="height" name="height" value="{{ $medical_exam->physical_examination->height }}" required> 
                                <span>cm</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col border">
                        <div class="row row-cols-1">
                            ...
                            <div class="col text-center pb-2">
                                <input type="number" class="physical_exam_input" id="weight" name="weight" value="{{ $medical_exam->physical_examination->weight }}" required> 
                                <span>kg</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col border">
                        <div class="row row-cols-1">
                            ...
                            <div class="col text-center pb-2">
                                <input type="number" class="physical_exam_input" id="top_bp" name="top_bp" value="{{ $medical_exam->physical_examination->top_bp }}" required> 
                                <span>/</span>
                                <input type="number" class="physical_exam_input" id="bot_bp" name="bot_bp" value="{{ $medical_exam->physical_examination->bot_bp }}" required> 
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col border">
                        <div class="row row-cols-1">
                            ...
                            <div class="col text-center pb-2">
                                <input type="number" class="physical_exam_input" id="pulse" name="pulse" value="{{ $medical_exam->physical_examination->pulse }}" required> 
                                <span>%</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col border">
                        <div class="row row-cols-1">
                            ...
                            <div class="col text-center pb-2">
                                <input type="number" class="physical_exam_input" id="respiratory_rate" name="respiratory_rate" value="{{ $medical_exam->physical_examination->respiratory_rate }}" required> 
                                <span>%</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col border">
                        <div class="row row-cols-1">
                            ...
                            <div class="col text-center pb-2">
                                <input type="number" class="physical_exam_input" id="bmi" name="bmi" style="pointer-events: none;" value="{{ $medical_exam->physical_examination->bmi }}" readonly>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col">
                    ...
                    <div class="col pr-0">
                        <table class="table table-sm table-bordered">
                            ...
                            <tr>
                                ...
                                <td class="text-center py-4">
                                    @if($medical_exam->physical_examination->pe_general_appearance === 'Yes')
                                    ...
                                    @else
                                    <input type="checkbox" id="pe_general_appearance" name="pe_general_appearance" value="Yes" onchange="toggleText_area('pe_general_appearance')">
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if($medical_exam->physical_examination->pe_general_appearance === 'Yes')
                                    ...
                                    @else
                                    <textarea class="form-control" id="findingText_area-pe_general_appearance" rows="2" name="pe_general_appearance_findings" required>
                                        {{ $medical_exam->physical_examination->pe_finding->pe_general_appearance_findings }}
                                    </textarea>
                                    @endif
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>Skin</td>
                                <td class="text-center py-4">
                                    @if($medical_exam->physical_examination->pe_skin === 'Yes')
                                    <input type="checkbox" id="pe_skin" name="pe_skin" value="Yes" onchange="toggleText_area('pe_skin')" checked>
                                    @else
                                    <input type="checkbox" id="pe_skin" name="pe_skin" value="Yes" onchange="toggleText_area('pe_skin')">
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if($medical_exam->physical_examination->pe_skin === 'Yes')
                                    ...
                                    @else
                                    <textarea class="form-control" id="findingText_area-pe_skin" rows="2" name="pe_skin_findings" required>
                                        {{ $medical_exam->physical_examination->pe_finding->pe_skin_findings }}
                                    </textarea>
                                    @endif
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center py-4">
                                    @if($medical_exam->physical_examination->pe_head_scalp === 'Yes')
                                    <input type="checkbox" id="pe_head_scalp" name="pe_head_scalp" value="Yes" onchange="toggleText_area('pe_head_scalp')" checked>
                                    @else
                                    <input type="checkbox" id="pe_head_scalp" name="pe_head_scalp" value="Yes" onchange="toggleText_area('pe_head_scalp')">
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if($medical_exam->physical_examination->pe_head_scalp === 'Yes')
                                    ...
                                    @else
                                    <textarea class="form-control" id="findingText_area-pe_head_scalp" rows="2" name="pe_head_scalp_findings" required>
                                        {{ $medical_exam->physical_examination->pe_finding->pe_head_scalp_findings }}
                                    </textarea>
                                    @endif
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>Eyes</td>
                                <td class="text-center py-4">
                                    @if($medical_exam->physical_examination->pe_eyes === 'Yes')
                                    <input type="checkbox" id="pe_eyes" name="pe_eyes" value="Yes" onchange="toggleNumber(this, 'pe_eyes')" checked>
                                    @else
                                    <input type="checkbox" id="pe_eyes" name="pe_eyes" value="Yes" onchange="toggleNumber(this, 'pe_eyes')">
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if($medical_exam->physical_examination->pe_eyes === 'Yes')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="row row-cols-1">
                                                ...
                                                <div class="col">
                                                    <input type="number" class="physical_exam_input" id="pe_eyes_top_od" name="pe_eyes_top_od" value="{{ $medical_exam->physical_examination->pe_finding->pe_eyes_top_od }}" required> 
                                                    <span>/</span>
                                                    <input type="number" class="physical_exam_input" id="pe_eyes_bot_od" name="pe_eyes_bot_od" value="{{ $medical_exam->physical_examination->pe_finding->pe_eyes_bot_od }}" required> 
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Eyes (OS) -->
                                        <div class="col">
                                            <div class="row row-cols-1">
                                                ...
                                                <div class="col">
                                                    <input type="number" class="physical_exam_input" id="pe_eyes_top_os" name="pe_eyes_top_os" value="{{ $medical_exam->physical_examination->pe_finding->pe_eyes_top_os }}" required> 
                                                    <span>/</span>
                                                    <input type="number" class="physical_exam_input" id="pe_eyes_bot_os" name="pe_eyes_bot_os" value="{{ $medical_exam->physical_examination->pe_finding->pe_eyes_bot_os }}" required> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center py-4">
                                    @if($medical_exam->physical_examination->pe_corrected === 'Yes')
                                    <input type="checkbox" id="pe_corrected" name="pe_corrected" value="Yes" onchange="toggleNumber(this, 'pe_corrected')" checked>
                                    @else
                                    <input type="checkbox" id="pe_corrected" name="pe_corrected" value="Yes" onchange="toggleNumber(this, 'pe_corrected')">
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if($medical_exam->physical_examination->pe_corrected === 'Yes')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="row row-cols-1">
                                                ...
                                                <div class="col">
                                                    <input type="number" class="physical_exam_input" id="pe_corrected_top_od" name="pe_corrected_top_od" value="{{ $medical_exam->physical_examination->pe_finding->pe_corrected_top_od }}" required> 
                                                    <span>/</span>
                                                    <input type="number" class="physical_exam_input" id="pe_corrected_bot_od" name="pe_corrected_bot_od" value="{{ $medical_exam->physical_examination->pe_finding->pe_corrected_bot_od }}" required> 
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Corrected (OS) -->
                                        <div class="col">
                                            <div class="row row-cols-1">
                                                ...
                                                <div class="col">
                                                    <input type="number" class="physical_exam_input" id="pe_corrected_top_os" name="pe_corrected_top_os" value="{{ $medical_exam->physical_examination->pe_finding->pe_corrected_top_os }}" required> 
                                                    <span>/</span>
                                                    <input type="number" class="physical_exam_input" id="pe_corrected_bot_os" name="pe_corrected_bot_os" value="{{ $medical_exam->physical_examination->pe_finding->pe_corrected_bot_os }}" required> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <tr>
                                <td>Pupils</td>
                                <td class="text-center py-4">
                                    @if($medical_exam->physical_examination->pe_pupils === 'Yes')
                                    <input type="checkbox" id="pe_pupils" name="pe_pupils" value="Yes" onchange="toggleText_area('pe_pupils')" checked>
                                    @else
                                    <input type="checkbox" id="pe_pupils" name="pe_pupils" value="Yes" onchange="toggleText_area('pe_pupils')">
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if($medical_exam->physical_examination->pe_pupils === 'Yes')
                                    ...
                                    @else
                                    <textarea class="form-control" id="findingText_area-pe_pupils" rows="2" name="pe_pupils_findings" required>
                                        {{ $medical_exam->physical_examination->pe_finding->pe_pupils_findings }}
                                    </textarea>
                                    @endif
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>Ear, Eardrums</td>
                                <td class="text-center py-4">
                                    @if($medical_exam->physical_examination->pe_ear_eardrums === 'Yes')
                                    <input type="checkbox" id="pe_ear_eardrums" name="pe_ear_eardrums" value="Yes" onchange="toggleText_area('pe_ear_eardrums')" checked>
                                    @else
                                    <input type="checkbox" id="pe_ear_eardrums" name="pe_ear_eardrums" value="Yes" onchange="toggleText_area('pe_ear_eardrums')">
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if($medical_exam->physical_examination->pe_ear_eardrums === 'Yes')
                                    ...
                                    @else
                                    <textarea class="form-control" id="findingText_area-pe_ear_eardrums" rows="2" name="pe_ear_eardrums_findings" required>
                                        {{ $medical_exam->physical_examination->pe_finding->pe_ear_eardrums_findings }}
                                    </textarea>
                                    @endif
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>Nose, Sinuses</td>
                                <td class="text-center py-4">
                                    @if($medical_exam->physical_examination->pe_nose_sinuses === 'Yes')
                                    <input type="checkbox" id="pe_nose_sinuses" name="pe_nose_sinuses" value="Yes" onchange="toggleText_area('pe_nose_sinuses')" checked>
                                    @else
                                    <input type="checkbox" id="pe_nose_sinuses" name="pe_nose_sinuses" value="Yes" onchange="toggleText_area('pe_nose_sinuses')">
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if($medical_exam->physical_examination->pe_nose_sinuses === 'Yes')
                                    ...
                                    @else
                                    <textarea class="form-control" id="findingText_area-pe_nose_sinuses" rows="2" name="pe_nose_sinuses_findings" required>
                                        {{ $medical_exam->physical_examination->pe_finding->pe_nose_sinuses_findings }}
                                    </textarea>
                                    @endif
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>Mouth, Throat</td>
                                <td class="text-center py-4">
                                    @if($medical_exam->physical_examination->pe_mouth_throat === 'Yes')
                                    <input type="checkbox" id="pe_mouth_throat" name="pe_mouth_throat" value="Yes" onchange="toggleText_area('pe_mouth_throat')" checked>
                                    @else
                                    <input type="checkbox" id="pe_mouth_throat" name="pe_mouth_throat" value="Yes" onchange="toggleText_area('pe_mouth_throat')">
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if($medical_exam->physical_examination->pe_mouth_throat === 'Yes')
                                    ...
                                    @else
                                    <textarea class="form-control" id="findingText_area-pe_mouth_throat" rows="2" name="pe_mouth_throat_findings" required>
                                        {{ $medical_exam->physical_examination->pe_finding->pe_mouth_throat_findings }}
                                    </textarea>
                                    @endif
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>Neck, Thyroid</td>
                                <td class="text-center py-4">
                                    @if($medical_exam->physical_examination->pe_neck_thyroid === 'Yes')
                                    <input type="checkbox" id="pe_neck_thyroid" name="pe_neck_thyroid" value="Yes" onchange="toggleText_area('pe_neck_thyroid')" checked>
                                    @else
                                    <input type="checkbox" id="pe_neck_thyroid" name="pe_neck_thyroid" value="Yes" onchange="toggleText_area('pe_neck_thyroid')">
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if($medical_exam->physical_examination->pe_neck_thyroid === 'Yes')
                                    ...
                                    @else
                                    <textarea class="form-control" id="findingText_area-pe_neck_thyroid" rows="2" name="pe_neck_thyroid_findings" required>
                                        {{ $medical_exam->physical_examination->pe_finding->pe_neck_thyroid_findings }}
                                    </textarea>
                                    @endif
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center py-4">
                                    @if($medical_exam->physical_examination->pe_chest_breast_axilla === 'Yes')
                                    ...
                                    @else
                                    <input type="checkbox" id="pe_chest_breast_axilla" name="pe_chest_breast_axilla" value="Yes" onchange="toggleText_area('pe_chest_breast_axilla')">
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if($medical_exam->physical_examination->pe_chest_breast_axilla === 'Yes')
                                    ...
                                    @else
                                    <textarea class="form-control" id="findingText_area-pe_chest_breast_axilla" rows="2" name="pe_chest_breast_axilla_findings" required>
                                        {{ $medical_exam->physical_examination->pe_finding->pe_chest_breast_axilla_findings }}
                                    </textarea>
                                    @endif
                                </td>
                            </tr>
                    ...
                    <div class="col pl-0">
                        <table class="table table-sm table-bordered">
                            ...
                            <tr>
                                ...
                                <td class="text-center py-4">
                                    @if($medical_exam->physical_examination->pe_heart_cardiovascular === 'Yes')
                                    ...
                                    @else
                                    <input type="checkbox" id="pe_heart_cardiovascular" name="pe_heart_cardiovascular" value="Yes" onchange="toggleText_area('pe_heart_cardiovascular')">
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if($medical_exam->physical_examination->pe_heart_cardiovascular === 'Yes')
                                    ...
                                    @else
                                    <textarea class="form-control" id="findingText_area-pe_heart_cardiovascular" rows="2" name="pe_heart_cardiovascular_findings" required>
                                        {{ $medical_exam->physical_examination->pe_finding->pe_heart_cardiovascular_findings }}
                                    </textarea>
                                    @endif
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center py-4">
                                    @if($medical_exam->physical_examination->pe_lungs_respiratory === 'Yes')
                                    ...
                                    @else
                                    <input type="checkbox" id="pe_lungs_respiratory" name="pe_lungs_respiratory" value="Yes" onchange="toggleText_area('pe_lungs_respiratory')">
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if($medical_exam->physical_examination->pe_lungs_respiratory === 'Yes')
                                    ...
                                    @else
                                    <textarea class="form-control" id="findingText_area-pe_lungs_respiratory" rows="2" name="pe_lungs_respiratory_findings" required>
                                        {{ $medical_exam->physical_examination->pe_finding->pe_lungs_respiratory_findings }}
                                    </textarea>
                                    @endif
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>Abdomen</td>
                                <td class="text-center py-4">
                                    @if($medical_exam->physical_examination->pe_abdomen === 'Yes')
                                    <input type="checkbox" id="pe_abdomen" name="pe_abdomen" value="Yes" onchange="toggleText_area('pe_abdomen')" checked>
                                    @else
                                    <input type="checkbox" id="pe_abdomen" name="pe_abdomen" value="Yes" onchange="toggleText_area('pe_abdomen')">
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if($medical_exam->physical_examination->pe_abdomen === 'Yes')
                                    ...
                                    @else
                                    <textarea class="form-control" id="findingText_area-pe_abdomen" rows="2" name="pe_abdomen_findings" required>
                                        {{ $medical_exam->physical_examination->pe_finding->pe_abdomen_findings }}
                                    </textarea>
                                    @endif
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>Back, Flanks</td>
                                <td class="text-center py-4">
                                    @if($medical_exam->physical_examination->pe_back_flanks === 'Yes')
                                    <input type="checkbox" id="pe_back_flanks" name="pe_back_flanks" value="Yes" onchange="toggleText_area('pe_back_flanks')" checked>
                                    @else
                                    <input type="checkbox" id="pe_back_flanks" name="pe_back_flanks" value="Yes" onchange="toggleText_area('pe_back_flanks')">
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if($medical_exam->physical_examination->pe_back_flanks === 'Yes')
                                    ...
                                    @else
                                    <textarea class="form-control" id="findingText_area-pe_back_flanks" rows="2" name="pe_back_flanks_findings" required>
                                        {{ $medical_exam->physical_examination->pe_finding->pe_back_flanks_findings }}
                                    </textarea>
                                    @endif
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>Anus, Rectum</td>
                                <td class="text-center py-4">
                                    @if($medical_exam->physical_examination->pe_anus_rectum === 'Yes')
                                    <input type="checkbox" id="pe_anus_rectum" name="pe_anus_rectum" value="Yes" onchange="toggleText_area('pe_anus_rectum')" checked>
                                    @else
                                    <input type="checkbox" id="pe_anus_rectum" name="pe_anus_rectum" value="Yes" onchange="toggleText_area('pe_anus_rectum')">
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if($medical_exam->physical_examination->pe_anus_rectum === 'Yes')
                                    ...
                                    @else
                                    <textarea class="form-control" id="findingText_area-pe_anus_rectum" rows="2" name="pe_anus_rectum_findings" required>
                                        {{ $medical_exam->physical_examination->pe_finding->pe_anus_rectum_findings }}
                                    </textarea>
                                    @endif
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center py-4">
                                    @if($medical_exam->physical_examination->pe_genito_urinary_system === 'Yes')
                                    ...
                                    @else
                                    <input type="checkbox" id="pe_genito_urinary_system" name="pe_genito_urinary_system" value="Yes" onchange="toggleText_area('pe_genito_urinary_system')">
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if($medical_exam->physical_examination->pe_genito_urinary_system === 'Yes')
                                    ...
                                    @else
                                    <textarea class="form-control" id="findingText_area-pe_genito_urinary_system" rows="2" name="pe_genito_urinary_system_findings" required>
                                        {{ $medical_exam->physical_examination->pe_finding->pe_genito_urinary_system_findings }}
                                    </textarea>
                                    @endif
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center py-4">
                                    @if($medical_exam->physical_examination->pe_inguinal_genitals === 'Yes')
                                    ...
                                    @else
                                    <input type="checkbox" id="pe_inguinal_genitals" name="pe_inguinal_genitals" value="Yes" onchange="toggleText_area('pe_inguinal_genitals')">
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if($medical_exam->physical_examination->pe_inguinal_genitals === 'Yes')
                                    ...
                                    @else
                                    <textarea class="form-control" id="findingText_area-pe_inguinal_genitals" rows="2" name="pe_inguinal_genitals_findings" required>
                                        {{ $medical_exam->physical_examination->pe_finding->pe_inguinal_genitals_findings }}
                                    </textarea>
                                    @endif
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>Musculo-Skeletal</td>
                                <td class="text-center py-4">
                                    @if($medical_exam->physical_examination->pe_musculo_skeletal === 'Yes')
                                    ...
                                    @else
                                    <input type="checkbox" id="pe_musculo_skeletal" name="pe_musculo_skeletal" value="Yes" onchange="toggleText_area('pe_musculo_skeletal')">
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if($medical_exam->physical_examination->pe_musculo_skeletal === 'Yes')
                                    ...
                                    @else
                                    <textarea class="form-control" id="findingText_area-pe_musculo_skeletal" rows="2" name="pe_musculo_skeletal_findings" required>
                                        {{ $medical_exam->physical_examination->pe_finding->pe_musculo_skeletal_findings }}
                                    </textarea>
                                    @endif
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>Extremities</td>
                                <td class="text-center py-4">
                                    @if($medical_exam->physical_examination->pe_extremities === 'Yes')
                                    <input type="checkbox" id="pe_extremities" name="pe_extremities" value="Yes" onchange="toggleText_area('pe_extremities')" checked>
                                    @else
                                    <input type="checkbox" id="pe_extremities" name="pe_extremities" value="Yes" onchange="toggleText_area('pe_extremities')">
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if($medical_exam->physical_examination->pe_extremities === 'Yes')
                                    ...
                                    @else
                                    <textarea class="form-control" id="findingText_area-pe_extremities" rows="2" name="pe_extremities_findings" required>
                                        {{ $medical_exam->physical_examination->pe_finding->pe_extremities_findings }}
                                    </textarea>
                                    @endif
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>Reflexes</td>
                                <td class="text-center py-4">
                                    @if($medical_exam->physical_examination->pe_reflexes === 'Yes')
                                    <input type="checkbox" id="pe_reflexes" name="pe_reflexes" value="Yes" onchange="toggleText_area('pe_reflexes')" checked>
                                    @else
                                    <input type="checkbox" id="pe_reflexes" name="pe_reflexes" value="Yes" onchange="toggleText_area('pe_reflexes')">
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if($medical_exam->physical_examination->pe_reflexes === 'Yes')
                                    ...
                                    @else
                                    <textarea class="form-control" id="findingText_area-pe_reflexes" rows="2" name="pe_reflexes_findings" required>
                                        {{ $medical_exam->physical_examination->pe_finding->pe_reflexes_findings }}
                                    </textarea>
                                    @endif
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>Neurological</td>
                                <td class="text-center py-4">
                                    @if($medical_exam->physical_examination->pe_neurological === 'Yes')
                                    <input type="checkbox" id="pe_neurological" name="pe_neurological" value="Yes" onchange="toggleText_area('pe_neurological')" checked>
                                    @else
                                    <input type="checkbox" id="pe_neurological" name="pe_neurological" value="Yes" onchange="toggleText_area('pe_neurological')">
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if($medical_exam->physical_examination->pe_neurological === 'Yes')
                                    ...
                                    @else
                                    <textarea class="form-control" id="findingText_area-pe_neurological" rows="2" name="pe_neurological_findings" required>
                                        {{ $medical_exam->physical_examination->pe_finding->pe_neurological_findings }}
                                    </textarea>
                                    @endif
                                </td>
                            </tr>
                ...
                <div class="row mx-auto mb-2">
                    <div class="col">
                        ...
                        <textarea class="form-control" name="diagnosis" row="3">{{ $medical_exam->physical_examination->pe_finding->diagnosis }}</textarea>
                    </div>
                </div>
