...
<a class="btn btn-danger mb-2" href="{{ route('doctor.recordShow', $record->id) }}">Go Back</a>

<!-- Body -->
<div class="container-xxl mb-2 record-customize-create-container-height">
    <form method="POST" action="{{ route('doctor.consultationStore') }}" onsubmit="return confirm('Are you sure you want to create this consultation?');">
        @csrf
