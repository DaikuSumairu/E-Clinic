...
@section('content_header')
    <h1>Update Consultation for {{ $consultation->record->user->name }}</h1>
@stop

<!-- Content Body -->
@section('content')
<!-- Go back from the last page -->
<a class="btn btn-danger mb-2" href="{{ route('doctor.recordShow', $consultation->record->id) }}">Go Back</a>

<!-- Body -->
<div class="container-xxl mb-2 record-customize-create-container-height">
    <form method="POST" action="{{ route('doctor.consultationUpdate', $consultation->id) }}" onsubmit="return confirm('Are you sure you want to update this consultation?');">
        @csrf
        @method('PUT')
        ...
        <div class="border border-2 row row-cols-2 pt-2 mt-2 mx-auto">
            ...
            <div class="col-md-5">
                <input type="text" class="form-control" name="complaint" value="{{ old('complaint', $consultation->consultation_response->complaint) }}" required>
            </div>
        </div>
                ...
                <div class="row mt-1 mx-auto">
                    ...
                    <div class="col pb-2 border border-1">
                        <div class="row row-cols-1">
                            ...
                            <div class="col text-center">
                                <input type="number" class="vital_sign_input" id="pulse" name="pulse" value="{{ old('pulse', $consultation->consultation_response->pulse) }}" required>
                    ...
                    <div class="col pb-2 border border-1">
                        <div class="row row-cols-1">
                            ...
                            <div class="col text-center">
                                <input type="number" class="vital_sign_input" id="oxygen" name="oxygen" value="{{ old('oxygen', $consultation->consultation_response->oxygen) }}" required>
                    ...
                    <div class="col pb-2 border border-1">
                        <div class="row row-cols-1">
                            ...
                            <div class="col text-center">
                                <input type="number" class="vital_sign_input" id="respiratory_rate" name="respiratory_rate" value="{{ old('respiratory_rate', $consultation->consultation_response->respiratory_rate) }}" required>
                                <span class="info">BPM</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col pb-2 border border-1">
                        <div class="row row-cols-1">
                            ...
                            <div class="col text-center">
                                <input type="number" class="vital_sign_input" id="top_bp" name="top_bp" value="{{ old('top_bp', $consultation->consultation_response->top_bp) }}" required>
                                <span class="info">/</span>
                                <input type="number" class="vital_sign_input" id="bot_bp" name="bot_bp" value="{{ old('bot_bp', $consultation->consultation_response->bot_bp) }}" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col pb-2 border border-1">
                        <div class="row row-cols-1">
                            ...
                            <div class="col text-center">
                                <input type="number" class="vital_sign_input" id="temperature" name="temperature" step="any" value="{{ old('temperature', $consultation->consultation_response->temperature) }}" required>
        ...
        <div class="border border-2 row row-cols-1 mt-1 py-2 mx-auto">
            ...
            <div class="col">
                <textarea class="form-control" name="treatment" value="{{ old('treatment') }}" rows="3">{{ $consultation->consultation_response->treatment }}</textarea>
            </div>
        </div>
        ...
        <div class="border border-2 row row-cols-1 mt-1 py-1 mx-auto">
            <div class="col">
                ...
                <select name="remarks" id="status">
                    <option value="Monitoring Case" @if($consultation->consultation_response->remarks == 'Monitoring Case') selected @endif>Monitoring Case</option>
                    <option value="Resolved Case" @if($consultation->consultation_response->remarks == 'Resolved Case') selected @endif>Resolved Case</option>
                </select>
            </div>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        var remark_status = document.getElementById('status');
        var date = document.getElementById('current_date');

        remark_status.addEventListener('change', function () {
            if (remark_status.value === 'Resolved Case') {
                date.name = "date_finished";
            } else {
                date.name = "date_updated";
            }
        });
    });
</script>
