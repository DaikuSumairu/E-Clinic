...
@section('content_header')
    ...
    @else
    <h1>You don't have a Health Record yet, Please go to the Clinic to have one.</h1>
    @endif
@stop
...
<!-- Body -->
@if($record)
<div class="container-xxl border mb-2 record-customize-container-height-patient">
    <!-- General Head -->
    ...
    <div class="border border-secondary mx-auto text-center" id="dental-exam-content-empty">
        <span class="info">No Dental Exam has been made</span> 
    </div>
...
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', function () {
        ...
        consultation_date.addEventListener('change', function () {
            ...
            var recordId = '@if($record) {{ $record->id }} @endif';
            ...
            $.ajax({
                type: 'GET',
                url: '/faculty/record/' + recordId + '/consultation/',
        ...
        medical_exam_date.addEventListener('change', function(){
            ...
            $.ajax({
                type: 'GET',
                url: '/faculty/record/' + recordId + '/medical-exam/',
        ...
        dental_exam_date.addEventListener('change', function(){
            ...
            $.ajax({
                type: 'GET',
                url: '/faculty/record/' + recordId + '/dental-exam/',
