...
<a class="btn btn-danger mb-2" href="{{ route('nurse.recordShow', $medical_exam->record->id) }}">Go Back</a>

<!-- Body -->
<div class="container-xxl mb-2 record-customize-create-container-height border">
    <form method="POST" action="{{ route('nurse.medicalExamUpdate', $medical_exam->id ) }}" onsubmit="return confirm('Are you sure you want to submit this medical exam?');">
        @csrf
        @method('PUT')
